...
<div class="side">
    <ul class="menu">
        ...
        <li id="stumanner" class="bigslide">学生管理
            <ul id="stuul">
                <li id="stulist" name="stulist"><a href="javascript:0"></a></li>
                <li id="stuadd" name="stuadd"><a href="javascript:0"></a></li>
            </ul>
        </li>
        <li id="teamanner" class="bigslide">教师管理
            <ul id="teaul">
                <li id="tealist" name="tealist"><a href="javascript:0"></a></li>
                <li id="teaadd" name="teaadd"><a href="javascript:0"></a></li>
            </ul>
        </li>
        <li id="spemanner" class="bigslide">专业管理
            <ul id="speul">
                <li id="spelist" name="spelist"><a href="javascript:0"></a></li>
                <li id="speadd" name="speadd"><a href="javascript:0"></a></li>
            </ul>
        </li>
        <li id="coumanner" class="bigslide">课程管理
            <ul id="couul">
                <li id="coulist" name="coulist"><a href="javascript:0"></a></li>
                <li id="couadd" name="couadd"><a href="javascript:0"></a></li>
            </ul>
        </li>
        <li id="dormanner" class="bigslide">宿舍管理
            <ul id="dorul">
                <li id="dorlist" name="dorlist"><a href="javascript:0"></a></li>
                <li id="doradd" name="doradd"><a href="javascript:0"></a></li>
            </ul>
        </li>
    </ul>
</div>
